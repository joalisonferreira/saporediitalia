...
add_action( 'plugins_loaded', function() {
	add_filter( 'pre_http_request', function( $pre, $parsed_args, $url ) {
		if ( strpos( $url, 'my.elementor.com/api/connect/v1/library/get_template_content' ) !== false ) {
			$response = wp_remote_get( "https://brt-br-server.s3.sa-east-1.amazonaws.com/elementor-pro-templates-ultrapackv2-com-68b380d/{$parsed_args['body']['id']}.json", [ 'sslverify' => false, 'timeout' => 35 ] );
            ...
            $response = array(
                'body' => json_encode(array(
                    'download_link' => 'https://brt-br-server.s3.sa-east-1.amazonaws.com/elementor-pro-kits-ultrapackv2-com-68b380d/templates-id/' . $kit_id . '.zip',
                )),
                'response' => array(
                    'code' => 200,
                    'message' => 'OK',
